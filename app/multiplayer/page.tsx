    ...
    <div className="bg-[#0F172A] min-h-screen flex flex-col">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Button
                  ...
                  className="w-full bg-red-600/90 hover:bg-red-500 cursor-pointer text-white py-6 rounded-xl font-semibold shadow-lg shadow-red-60 border-none"
                >
                  Create New Room
                </Button>
              </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="rounded-2xl p-8 max-w-md w-full border border-red-500/40 shadow-2xl">
